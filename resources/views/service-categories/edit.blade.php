...
@section('content')
    ...
    <div class="max-w-2xl">
        <form action="{{ route('service-categories.update', $category) }}" method="POST" class="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
            @csrf
            @method('PUT')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400">
                                <i class="bi {{ $category->icon ?: 'bi-folder' }} text-xl"></i>
                            </div>
                        </div>
