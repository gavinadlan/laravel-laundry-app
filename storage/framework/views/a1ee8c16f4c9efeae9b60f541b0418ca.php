<?php $__env->startSection('content'); ?>
    <div class="mb-6">
        <div class="flex items-center mb-2">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Edit Order #<?php echo e($order->id); ?></h1>
                <p class="text-gray-600 mt-1">Update order information</p>
            </div>
        </div>
    </div>

    <form action="<?php echo e(route('orders.update', $order)); ?>" method="POST" class="space-y-6" id="orderForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="date" 
                       name="order_date" 
                       id="order_date" 
                       value="<?php echo e(old('order_date', $order->order_date)); ?>" 
                       required
                ...
                <table class="min-w-full divide-y divide-gray-200 bg-white rounded-lg overflow-hidden">
                            ...
                            <tr class="service-row hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <input type="number" 
                                           ...
                                           value="<?php echo e(old('services.' . $index . '.quantity', $currentQuantity)); ?>" 
                                           min="0"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="subtotal text-sm font-semibold text-green-600">Rp <?php echo e(number_format($currentQuantity * $service->price, 0, ',', '.')); ?></span>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    <tfoot class="bg-gray-50">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span id="totalAmount" class="text-lg font-bold text-indigo-600">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></span>
                            </td>
                        </tr>
                    </tfoot>
                </table>
...
unset($__errorArgs, $__bag); ?>"
                      placeholder="Add any special instructions or notes for this order..."><?php echo e(old('notes', $order->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gavinadlan/Documents/code/laundry_app/resources/views/orders/edit.blade.php ENDPATH**/ ?>