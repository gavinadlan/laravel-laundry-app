    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('orders.edit', $order)); ?>" class="inline-flex items-center px-4 py-2 bg-yellow-100 text-yellow-700 font-semibold rounded-xl hover:bg-yellow-200 transition-colors duration-200">
                    <i class="bi bi-pencil mr-2"></i>Edit
                </a>
                <a href="<?php echo e(route('orders.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-colors duration-200">
                ...
                <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            ?>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold <?php echo e($config['bg']); ?> <?php echo e($config['text']); ?>">
                                <i class="bi bi-<?php echo e($config['icon']); ?> mr-2"></i>
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-900 mt-1">
                                        <?php echo e(date('M d, Y', strtotime($order->order_date))); ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $order->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm text-gray-900">Rp <?php echo e(number_format($service->price, 0, ',', '.')); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm font-semibold text-gray-900"><?php echo e($service->pivot->quantity); ?></span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="text-sm font-bold text-green-600">Rp <?php echo e(number_format($service->price * $service->pivot->quantity, 0, ',', '.')); ?></span>
                                    </td>
                                </tr>
                        ...
                        <tfoot class="bg-gray-50">
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-lg font-bold text-indigo-600">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></span>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-900"><?php echo e($order->customer->name); ?></p>
                    </div>
                    <?php if($order->customer->phone): ?>
                    <div>
                        <p class="text-sm text-gray-500">Phone</p>
                        <p class="text-lg font-semibold text-gray-900"><?php echo e($order->customer->phone); ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if($order->customer->email): ?>
                    <div>
                        <p class="text-sm text-gray-500">Email</p>
                        <p class="text-lg font-semibold text-gray-900"><?php echo e($order->customer->email); ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if($order->customer->address): ?>
                    <div>
                        <p class="text-sm text-gray-500">Address</p>
                        <p class="text-sm text-gray-900"><?php echo e($order->customer->address); ?></p>
                    </div>
                    <?php endif; ?>
                    <div class="pt-4 border-t border-gray-200">
                        <a href="<?php echo e(route('customers.show', $order->customer)); ?>" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-800 font-medium">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div class="bg-green-50 rounded-xl p-4 border border-green-200">
                            ...
                            <p class="text-2xl font-bold text-green-700">
                                Rp <?php echo e(number_format($order->payment->amount, 0, ',', '.')); ?>
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-900">
                                <?php echo e(date('M d, Y', strtotime($order->payment->payment_date))); ?>

                            </p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Method</p>
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($order->payment->method); ?></p>
                        </div>
                        <?php if($order->payment->reference): ?>
                        <div>
                            <p class="text-sm text-gray-500">Reference</p>
                            <p class="text-sm font-semibold text-gray-900"><?php echo e($order->payment->reference); ?></p>
                        </div>
                        <?php endif; ?>
                        <div class="pt-4 border-t border-gray-200">
                            <a href="<?php echo e(route('payments.show', $order->payment)); ?>" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-800 font-medium">
                ...
                <?php else: ?>
                    <div class="text-center py-8">
                        ...
                        <a href="<?php echo e(route('payments.create')); ?>?order_id=<?php echo e($order->id); ?>" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gavinadlan/Documents/code/laundry_app/resources/views/orders/show.blade.php ENDPATH**/ ?>